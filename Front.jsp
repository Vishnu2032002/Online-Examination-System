...
<body>
    ...
    <div class="main">
        <div class="navbar">
            <div class="icon"><br>
                <h2 class="logo">ONLINE &nbsp&nbsp&nbsp&nbsp EXAMINATION  &nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp SYSTEM</h2>
            ...
            <div class="menu">
                <ul>
                    <li><a href="Admin_log.jsp"><h3>ADMIN</h3></a></li>
                    <li><a href="First.html"><h3>SIGN_IN</h3></a></li>
                    <!-- First.html -->
                     <li><a href="about.jsp" class="active"><h3>ABOUT</h3></a></li>
